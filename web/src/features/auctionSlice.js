...
//   return { id, currentBid: data.currentBid, currentWinner: data.currentWinner };
// });
...
//         state.items[idx].currentWinner = action.payload.userId;
//       }
//       if (state.selected?._id === action.payload.auctionId) {
//         state.selected.currentBid = action.payload.amount;
//         state.selected.currentWinner = action.payload.userId;
//       }
//     },
...
//     builder
//       .addCase(fetchAuctions.fulfilled, (state, action) => { state.items = action.payload; })
//       .addCase(createAuction.fulfilled, (state, action) => { state.items.unshift(action.payload); })
